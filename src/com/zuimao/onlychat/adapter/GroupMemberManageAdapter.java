...
import com.zuimao.onlychat.activity.GroupListActivity;
import com.zuimao.onlychat.activity.SetSlienceTimeActivity;
...
import com.zuimao.onlychat.activity.GroupMemberManageActivity;
   ...
   private List<TIMGroupMemberInfo> listMember;
	...
	public View getView(int position, View convertView, ViewGroup parent) {	
		...
		if(name.equals(TLSHelper.userID)){
			...
			com.zuimao.onlychat.c2c.UserInfo user= UserInfoManagerNew.getInstance().getContactsList().get(name);
